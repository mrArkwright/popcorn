...
int main(){
	...
	printf("eins: %d\n", ( (unit*) getFromHashlist("eins",hashList)->dataPtr)->id);
	printf("zwei: %d\n", ( (unit*) getFromHashlist("zwei",hashList)->dataPtr)->id);
	printf("drei: %d\n", ( (unit*) getFromHashlist("drei",hashList)->dataPtr)->id);
	printf("vier: %d\n", ( (unit*) getFromHashlist("vier",hashList)->dataPtr)->id);
	freeList(hashList);
